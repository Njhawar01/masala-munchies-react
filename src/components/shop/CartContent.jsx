    ...
    <div className="flex flex-col h-full min-h-0 bg-white">
            ...
            {cart.map(item => {
              ...
              return (
                <div key={item.variantId} className="flex justify-between items-center pb-4 border-b border-gray-100 last:border-0 last:pb-0 gap-2">
                  {/* Issue 2: Show the item MRP, cut it, and show sale price */}
      ...
      {cart.length > 0 && (
        <div className="p-4 bg-gray-50 border-t border-gray-100 mt-auto shrink-0 space-y-3.5">
          ...
          {/* Issue 3: Dynamic Free Delivery Banner Tracker */}
          {deliveryFee > 0 && amountNeededForFreeDelivery > 0 && (
            <div className="p-2.5 bg-amber-50 border border-amber-200 rounded-xl flex items-center gap-2.5 text-amber-800 text-xs font-medium animate-pulse">
          ...
          {/* Issue 2: Fixed Div Summary Breakdown Sequence */}
          <div className="space-y-1.5 text-sm">
            <div className="flex justify-between text-gray-500">
              <span>Subtotal</span>
              <div className="flex items-center gap-1.5">
                {totalMrp > cartTotal && (
                  <span className="line-through text-gray-400 text-xs">₹{totalMrp}</span>
                )}
          ...
          {/* WhatsApp Checkout Button - Minimum floor disabled */}
          <button 
